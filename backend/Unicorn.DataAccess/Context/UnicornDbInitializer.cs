...
namespace Unicorn.DataAccess.Context
{
    public class UnicornDbInitializer : DropCreateDatabaseIfModelChanges<AppContext>
    {
        protected override void Seed(AppContext context)
        {
            ...
            context.Permissions.AddRange(entities: new List<Permission> { permision1, permision2, permision3, permision4, permision5, permision6, permision7, permision8, permision9, permision10, permision11 });
            ...
            context.Roles.AddRange(entities: new List<Role> { role1, role2, role3, role4, role5 });
            ...
            context.ContactProviders.AddRange(entities: new List<ContactProvider> { phone, email, skype, telegram, facebook, vk, linkedin });
            ...
            context.Contacts.AddRange(entities: new List<Contact>
            {
            ...
            context.Locations.AddRange(entities: new List<Location> { location1, location2, location3, location4, location5, location6, location7, location8, location9, location10, location11, location12, location13, location14, location15, location16, location17, location18 });
            ...
            context.SocialAccounts.AddRange(entities: new List<SocialAccount>
            {
            ...
            context.Categories.AddRange(entities: new List<Category>
            {
            ...
            context.Subcategories.AddRange(entities: new List<Subcategory>
            {
            ...
            context.Works.AddRange(entities: new List<Work> { work1, work2, work3, work4, work5, work6, work7, work8, work9, work10, work11, work12, work13, work14, work15, work16, work17, work18, work19, work20, work21, work22 });
            ...
            context.PortfolioItems.AddRange(entities: new List<PortfolioItem> { portfolioItem1 });
            ...
            context.Calendars.AddRange(entities: new List<Calendar> { calendar1, calendar2, calendar3, calendar4, calendar5, calendar6, calendar7, calendar8, calendar9, calendar10 });
            ...
            context.Accounts.AddRange(entities: new List<Account> { account1, account2, account3, account4, account5, account6, account7, account8, account9, account10, account11, account12, account13, account14, account15, account16 });
            ...
            context.Vendors.AddRange(entities: new List<Vendor> { vendor1, vendor2, vendor3, vendor4, vendor5 });
            ...
            context.Companies.AddRange(entities: new List<Company>
            {
            ...
            context.Customers.AddRange(entities: new List<Customer> { customer1, customer2, customer3, customer4, customer5, customer6 });
            ...
            context.Books.AddRange(entities: new List<Book> { book1, book2, book3, book4, book5, book6, book7, book8, book9, book10, book11, book12, book13, book14, book15, book16, book17, book18, book19, book20, book21, book22, book23, book24, book25, book26, book27, book28, book29, book30, book31, book32, book33 });
            ...
            context.Reviews.AddRange(entities: new List<Review> { review1, review2, review3, review4, review5, review6, review7, review8 });
           ...
           History history1 = new History
            ...
            context.Histories.AddRange(entities: new List<History> { history1 });
            ...
            context.Ratings.AddRange(entities: new List<Rating> { rating1, rating2, rating3, rating4, rating5, rating6 });
            #endregion
