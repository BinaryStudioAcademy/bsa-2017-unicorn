...
namespace Unicorn.DataAccess.Context
{
    public class UnicornDbInitializer : DropCreateDatabaseAlways<AppContext>
    {
        protected override void Seed(AppContext context)
        {
            ...
            {
                Id = 1,
                Description = "Wash clothes wtith temperature 40",
                Name = "Washing",
                IsDeleted = false,
                Category = category1
            };
            ...
            {
                Id = 2,
                Description = "Iron clothes in the second position of the iron",
                Name = "Iron Clothes",
                IsDeleted = false,
                Category = category1
            };
            ...
            Book book2 = new Book()
            {
                ...
                IsDeleted = false,
                Work = work1,
                Description = "Make i photoset when sunrise",
                Status = "Search"
            };
            ...
            Customer customer2 = new Customer()
            {
                ...
                IsDeleted = false,
                Person = person7,
                Books = new List<Book>() { book3, book4 }
            };
            ...
            Customer customer3 = new Customer()
            {
                ...
                IsDeleted = false,
                Person = person8,
                Books = new List<Book>() { book5, book6 }
            };
