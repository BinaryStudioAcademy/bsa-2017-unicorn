namespace Unicorn.Shared.DTOs.Email
{
    public static class EmailTemplate
    {
        ...
        public static string NewOrderTemplate(string personFirstName, string personeLastName, string workName)
        {            
            string body = $"<body class><table border=0 cellpadding=0 cellspacing=0 class=body><tr><td>&nbsp;</td><td class=container><div class=content><table class=main><tr><td class=wrapper><table border=0 cellpadding=0 cellspacing=0><tr><td><p>Hi there,</p><p>{personFirstName} {personeLastName} booked {workName}. You can review details of this order in your dashboard.</p><table border=0 cellpadding=0 cellspacing=0 class=\"btn btn-primary\"><tbody><tr><td align=center><table border=0 cellpadding=0 cellspacing=0><tbody><tr><td> <a href={dashBoardLink} target=_blank>Go To Dashboard</a> </td></tr></tbody></table></td></tr></tbody></table></td></tr></table></td></tr></table>";
